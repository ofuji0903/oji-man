...
export default function Home() {
  ...
  const handleSubmit = async () => {
    ...
    const newTrust = Math.max(0, Math.min(100, trust + data.trustChange));
  ...
  return (
    <div className="relative w-full min-h-screen bg-black">
      ...
      <div className="absolute bottom-16 left-0 w-full px-6">
        <div className="bg-black bg-opacity-70 text-white rounded p-4 space-y-1 text-sm md:text-base">
          {messages.map((msg, i) => (
            <div key={i}>
